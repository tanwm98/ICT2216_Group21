...
const { loginValidator, registerValidator, ownerValidator } = require('../middleware/validators');
...
// Owner signup
router.post('/signup-owner', upload.single('image'), ownerValidator, handleValidation, async (req, res) => {
  const {
    ownerName,
    firstname,
    lastname,
  ...
  const message = `New Restaurant Owner Signup:
